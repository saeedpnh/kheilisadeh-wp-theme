      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="#about-me" class="nav-link js-scroll-trigger">درباره من</a></li>
            <li class="nav-item"><a href="#skills-percent" class="nav-link js-scroll-trigger">تخصص ها</a></li>
            <li class="nav-item"><a href="<?php echo site_url('/blog'); ?>" class="nav-link js-scroll-trigger">وبلاگ</a></li>
          </ul>
        </div>
      </div>
    </nav>
